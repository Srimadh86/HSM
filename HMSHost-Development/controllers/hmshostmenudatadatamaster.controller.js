...
const HmsHostMenudata = db.menudata;
exports.list = async(req,res)=>{
    const hmshostmenudata = await HmsHostMenudata.findAll({include: ["airportlocation","batchmaster","desseqmasters","department","storemaster","menuitemmaster","microlocationmaster","menucategory","menusubcategories","standardmenucategorymaster"],order: [['HSM_HMD_ID', 'DESC']]});
    ...
    if(hmshostmenudata)
    {
        ...
        {    
            var array = [];
            for (var key in hmshostmenudata) 
            {             
                var editable = []; 
                if(hmshostmenudata[key]['Batch_ID'] == null)
                {
                    var Batch_ID =  null;
                }
                else
                {
                    var Batch_ID =  hmshostmenudata[key]['batchmaster']['Batch_ID'];
                }                  
                if(hmshostmenudata[key]['Def_Sequence_ID'] == null)
                {
                    var Def_Sequence_Value =  null;
                }
                else
                {
                    var Def_Sequence_Value =  hmshostmenudata[key]['desseqmasters']['Def_Sequence_Value'];
                }
                if(hmshostmenudata[key]['Department_ID'] == null)
                {
                    var Department_Value =  null;
                }
                else
                {
                    var Department_Value =  hmshostmenudata[key]['department']['Department_Value'];
                }
                if(hmshostmenudata[key]['HMSHost_Store_ID'] == null)
                {
                    var Store_Name =  null;
                }
                else
                {
                    var Store_Name =  hmshostmenudata[key]['storemaster']['Store_Name'];
                }
                if(hmshostmenudata[key]['HMSHost_Menu_Item_ID'] == null)
                {
                    var HMSHost_Menu_Item_Name =  null;
                }
                else
                {
                    var HMSHost_Menu_Item_Name =  hmshostmenudata[key]['menuitemmaster']['HMSHost_Menu_Item_Name'];
                }
                if(hmshostmenudata[key]['Micro_Location_ID'] == null)
                {
                    var Micro_Location_Value =  null;
                }
                else
                {
                    var Micro_Location_Value =  hmshostmenudata[key]['microlocationmaster']['Micro_Location_Value'];
                }
                if(hmshostmenudata[key]['POS_Category_ID'] == null)
                {
                    var POS_Category_Name =  null;
                }
                else
                {
                    var POS_Category_Name =  hmshostmenudata[key]['menucategory']['POS_Category_Name'];
                }
                if(hmshostmenudata[key]['POS_Subcategory_ID'] == null)
                {
                    var POS_Subcategory_Name =  null;
                }
                else
                {
                    var POS_Subcategory_Name =  hmshostmenudata[key]['menusubcategories']['POS_Subcategory_Name'];
                }
                if(hmshostmenudata[key]['HMSHost_Standardized_Menu_Category_ID'] == null)
                {
                    var HMSHost_Standardized_Menu_Category_name =  null;
                }
                else
                {
                    var HMSHost_Standardized_Menu_Category_name =  hmshostmenudata[key]['standardmenucategorymaster']['HMSHost_Standardized_Menu_Category_name'];
                }
                editable.push({
                    POS_Price:hmshostmenudata[key]['POS_Price'],
                    Def_Sequence_Value:Def_Sequence_Value,
                })               
             
                array.push({            
                    HSM_HMD_ID:hmshostmenudata[key]['HSM_HMD_ID'],       
                    Transaction_ID:hmshostmenudata[key]['Transaction_ID'],
                    Airport_Name:hmshostmenudata[key]['airportlocation']['Airport_Name'],
                    Batch_ID:Batch_ID,
                    Department_Value:Department_Value,
                    Store_Name:Store_Name,
                    HMSHost_Menu_Item_Name:HMSHost_Menu_Item_Name,                   
                    Micro_Location_Value:Micro_Location_Value,
                    POS_Menu_Item_ID:hmshostmenudata[key]['POS_Menu_Item_ID'],
                    POS_Category_Name:POS_Category_Name,                   
                    POS_Subcategory_Name:POS_Subcategory_Name,
                    Calories:hmshostmenudata[key]['Calories'],                   
                    Note:hmshostmenudata[key]['Note'],
                    HMSHost_Menu_Item_ID:hmshostmenudata[key]['HMSHost_Menu_Item_ID'],
                    HMSHost_Current_Price:hmshostmenudata[key]['HMSHost_Current_Price'],                   
                    HMSHost_Standardized_Menu_Category_name:HMSHost_Standardized_Menu_Category_name,
                    Annualized_QTY_Sold:hmshostmenudata[key]['Annualized_QTY_Sold'],                   
                    Lookup_Value:hmshostmenudata[key]['Lookup_Value'],
                    ipAddress:hmshostmenudata[key]['ipAddress'],
                    status:hmshostmenudata[key]['status'],
                    editable:editable
                });
            }
        }
